...
listmonk_database_socket_path_host: ""
```
...
listmonk_database_socket_enabled: false
...
See its [environment variables](https://listmonk.app/docs/configuration/#environment-variables) for a complete list of listmonk's config options that you can put in `listmonk_environment_variables_additional_variables`.
